...
if(!defined('API_URL')) define('API_URL', "http://mapa.cultura.ce.gov.br/api/");

if(!defined('REPLACE_IMAGES_URL_FROM')) define('REPLACE_IMAGES_URL_FROM', 'http://mapa.cultura.ce.gov.br/files/');

if(!defined('REPLACE_IMAGES_URL_TO')) define('REPLACE_IMAGES_URL_TO', 'http://mapa.cultura.ce.gov.br/files/');

$project_id = 33;

$date_from = '2016-04-28';
$date_to = '2016-05-01';
